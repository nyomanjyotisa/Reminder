...
$tdatavalidate_order[".afterAddAction"] = 0;
...
$arrGridTabs[] = array(
	...
	'name' => "All data",
	'nameType' => 'Text',
	'where' => "group_id = ':session.group_id' and valid = 'not valid'",
	'showRowCount' => 0,
	'hideEmpty' => 0,
);
