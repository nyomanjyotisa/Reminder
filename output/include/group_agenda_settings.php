...
if(mlang_getcurrentlang()=="English")
{
	...
	$pageTitlesgroup_agenda["English"]["edit"] = "Edit Group Agenda {%group_id}";
	$pageTitlesgroup_agenda["English"]["view"] = "Group Agenda {%group_id}";
...
if( $pages[PAGE_EDIT] ) {
	...
	$tdatagroup_agenda[".afterEditAction"] = 0;
...
$tdatagroup_agenda[".afterAddAction"] = 4;
$tdatagroup_agenda[".closePopupAfterAdd"] = 1;
$tdatagroup_agenda[".afterAddActionDetTable"] = "group_agenda_repeat_date";
}
...
$tdatagroup_agenda[".addPageEvents"] = true;
...
$tdatagroup_agenda[".sqlHead"] = "SELECT group_agenda_id,  	group_id,  	agenda_type_id,  	message_general,  	agenda_name,  	message_content,  	attachment,  	loop_id,  	loop_value,  	`repeat`,  	repeat_type,  	send_date";
...
$tdatagroup_agenda[".arrGridTabs"] = $arrGridTabs;
...
//Filters settings
	$fdata["filterTotals"] = 0;
		$fdata["filterMultiSelect"] = 0;
		$fdata["filterTotalFields"] = "group_agenda_id";
		$fdata["filterFormat"] = "Values list";
		$fdata["showCollapsed"] = false;
...
$masterTablesData["group_agenda"] = array();
	...
	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["group_agenda"][3] = $masterParams;
				$masterTablesData["group_agenda"][3]["masterKeys"] = array();
	$masterTablesData["group_agenda"][3]["masterKeys"][]="group_id";
				$masterTablesData["group_agenda"][3]["detailKeys"] = array();
	$masterTablesData["group_agenda"][3]["detailKeys"][]="group_id";
	...
	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["group_agenda"][4] = $masterParams;
				$masterTablesData["group_agenda"][4]["masterKeys"] = array();
	$masterTablesData["group_agenda"][4]["masterKeys"][]="group_id";
				$masterTablesData["group_agenda"][4]["detailKeys"] = array();
	$masterTablesData["group_agenda"][4]["detailKeys"][]="group_id";
...
$proto0["m_strFieldList"] = "group_agenda_id,  	group_id,  	agenda_type_id,  	message_general,  	agenda_name,  	message_content,  	attachment,  	loop_id,  	loop_value,  	`repeat`,  	repeat_type,  	send_date";
