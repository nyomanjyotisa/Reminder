...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelsadmin_members["English"]["valid"] = "Valid";
	$fieldToolTipsadmin_members["English"]["valid"] = "";
	$placeHoldersadmin_members["English"]["valid"] = "";
...
if(mlang_getcurrentlang()=="Indonesian")
{
	...
	$fieldLabelsadmin_members["Indonesian"]["valid"] = "Valid";
	$fieldToolTipsadmin_members["Indonesian"]["valid"] = "";
	$placeHoldersadmin_members["Indonesian"]["valid"] = "";
...
$tdataadmin_members[".googleLikeFields"][] = "valid";
...
$tdataadmin_members[".sqlHead"] = "SELECT member_id,  	name,  	mail,  	password,  	country_id,  	province_id,  	valid";
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "personal";
	$fdata["Label"] = GetFieldLabel("admin_members","valid");
	$fdata["FieldType"] = 16;
...
//end of Filters settings
	...
	$tdataadmin_members["valid"] = $fdata;
		$tdataadmin_members[".searchableFields"][] = "valid";
