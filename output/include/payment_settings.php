...
$tdatapayment[".addPageEvents"] = true;
...
$arrGridTabs[] = array(
	...
	'name' => "All data",
	'nameType' => 'Text',
	'where' => "group_member_order.group_id = ':session.group_id' and group_member_order.payment_status = \"not_paid\"",
	'showRowCount' => 0,
	'hideEmpty' => 0,
);
