...
$keyvalues["group_member_id"] = $deleted_values["group_member_id"];

DB::Update("group_member_agenda", $data, $keyvalues );
DB::Update("group_member_agenda_subscriber", $data, $keyvalues );
...
$data1 = array();
$data1["group_member_id"] = $deleted_values["group_member_id"];
$data1["flag"] = '1';
...
DB::Delete("group_member_agenda_subscriber", $data );
