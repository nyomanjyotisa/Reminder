...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelsgroup_agenda_type["English"]["group_id"] = "Group";
	...
	$pageTitlesgroup_agenda_type["English"]["edit"] = "Edit Group Agenda Type {%agenda_type}";
	$pageTitlesgroup_agenda_type["English"]["view"] = "Group Agenda Type {%agenda_type}";
...
if( $pages[PAGE_EDIT] ) {
	...
	$tdatagroup_agenda_type[".afterEditAction"] = 0;
...
$tdatagroup_agenda_type[".afterAddAction"] = 0;
...
$tdatagroup_agenda_type[".arrGridTabs"] = $arrGridTabs;
...
$masterTablesData["group_agenda_type"] = array();
	...
	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["group_agenda_type"][1] = $masterParams;
				$masterTablesData["group_agenda_type"][1]["masterKeys"] = array();
	$masterTablesData["group_agenda_type"][1]["masterKeys"][]="group_id";
				$masterTablesData["group_agenda_type"][1]["detailKeys"] = array();
	$masterTablesData["group_agenda_type"][1]["detailKeys"][]="group_id";
	...
	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["group_agenda_type"][2] = $masterParams;
				$masterTablesData["group_agenda_type"][2]["masterKeys"] = array();
	$masterTablesData["group_agenda_type"][2]["masterKeys"][]="group_id";
				$masterTablesData["group_agenda_type"][2]["detailKeys"] = array();
	$masterTablesData["group_agenda_type"][2]["detailKeys"][]="group_id";
		
	
				$strOriginalDetailsTable="group_member_agenda_subscriber";
	$masterParams = array();
	$masterParams["mDataSourceTable"]="group_member_agenda_subscriber";
	$masterParams["mOriginalTable"]= $strOriginalDetailsTable;
	$masterParams["mShortTable"]= "group_member_agenda_subscriber";
	$masterParams["masterKeys"]= array();
	$masterParams["detailKeys"]= array();

	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["group_agenda_type"][3] = $masterParams;
				$masterTablesData["group_agenda_type"][3]["masterKeys"] = array();
	$masterTablesData["group_agenda_type"][3]["masterKeys"][]="agenda_type_id";
				$masterTablesData["group_agenda_type"][3]["detailKeys"] = array();
	$masterTablesData["group_agenda_type"][3]["detailKeys"][]="agenda_type_id";
...
$tdatagroup_agenda_type[".hasEvents"] = true;
