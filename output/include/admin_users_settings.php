...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelsadmin_users["English"]["valid"] = "Valid";
	$fieldToolTipsadmin_users["English"]["valid"] = "";
	$placeHoldersadmin_users["English"]["valid"] = "";
...
if(mlang_getcurrentlang()=="Indonesian")
{
	...
	$fieldLabelsadmin_users["Indonesian"]["valid"] = "Valid";
	$fieldToolTipsadmin_users["Indonesian"]["valid"] = "";
	$placeHoldersadmin_users["Indonesian"]["valid"] = "";
...
$tdataadmin_users[".googleLikeFields"][] = "valid";
...
$tdataadmin_users[".sqlHead"] = "SELECT member_id,  	name,  	mail,  	password,  	country_id,  	province_id,  	valid";
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "personal";
	$fdata["Label"] = GetFieldLabel("admin_users","valid");
	$fdata["FieldType"] = 16;
...
//end of Filters settings
	...
	$tdataadmin_users["valid"] = $fdata;
		$tdataadmin_users[".searchableFields"][] = "valid";
