...
function BeforeAdd(&$values, &$message, $inline, &$pageObject)
{
		...
		$sql = "SELECT * FROM group_member_checkin WHERE (checkin_date > '" . $values['checkin_date'] .
				"' AND checkin_date < '" . $values['checkout_date'] .
				"' ) OR ( checkin_date < '" . $values['checkin_date'] .  
				"' AND checkout_date > '" . $values['checkin_date'] . "' )";
$preparedSQL = DB::PrepareSQL( $sql );
$result = DB::Query( $preparedSQL );
if($result->fetchAssoc()) {
	$message = "Room/table sudah tidak tersedia pada waktu yang anda pilih";
	return false;
}
