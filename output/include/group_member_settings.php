...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelsgroup_member["English"]["memberID"] = "Member ID";
	$fieldToolTipsgroup_member["English"]["memberID"] = "";
	$placeHoldersgroup_member["English"]["memberID"] = "";
...
if(mlang_getcurrentlang()=="Indonesian")
{
	...
	$fieldLabelsgroup_member["Indonesian"]["memberID"] = "Member ID";
	$fieldToolTipsgroup_member["Indonesian"]["memberID"] = "";
	$placeHoldersgroup_member["Indonesian"]["memberID"] = "";
...
if( $pages[PAGE_EDIT] ) {
	...
	$tdatagroup_member[".afterEditAction"] = 0;
	$tdatagroup_member[".closePopupAfterEdit"] = 1;
	$tdatagroup_member[".afterEditActionDetTable"] = "group_member_agenda";
}

if( $pages[PAGE_ADD] ) {
$tdatagroup_member[".add"] = true;
$tdatagroup_member[".afterAddAction"] = 0;
...
$tdatagroup_member[".googleLikeFields"][] = "memberID";
...
$tdatagroup_member[".sqlHead"] = "SELECT group_member_id,  	member_id AS memberID,  	member_id,  	group_id,  	user_type,  	token_group,  	identifier_group,  	token_personal,  	membership_type,  	valid";
...
$arrGridTabs[] = array(
	...
	'name' => "Admin",
	'nameType' => 'Text',
	'where' => "group_id = ':session.group_id' and group_member.valid = 1",
	'showRowCount' => 0,
	'hideEmpty' => 1,
);
$arrGridTabs[] = array(
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "group_member";
	$fdata["Label"] = GetFieldLabel("group_member","memberID");
	$fdata["FieldType"] = 20;
...
//end of Filters settings
	...
	$tdatagroup_member["memberID"] = $fdata;
		$tdatagroup_member[".searchableFields"][] = "memberID";
//	member_id
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 3;
...
// Begin Lookup settings
	...
	$edata["LookupValues"][] = "NIM";
	$edata["LookupValues"][] = "No KTP";
	$edata["LookupValues"][] = "No Anggota";
	$edata["LookupValues"][] = "NIP";
...
$masterTablesData["group_member"] = array();
	...
	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["group_member"][4] = $masterParams;
				$masterTablesData["group_member"][4]["masterKeys"] = array();
	$masterTablesData["group_member"][4]["masterKeys"][]="group_id";
				$masterTablesData["group_member"][4]["detailKeys"] = array();
	$masterTablesData["group_member"][4]["detailKeys"][]="group_id";
	...
	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["group_member"][5] = $masterParams;
				$masterTablesData["group_member"][5]["masterKeys"] = array();
	$masterTablesData["group_member"][5]["masterKeys"][]="group_id";
				$masterTablesData["group_member"][5]["detailKeys"] = array();
	$masterTablesData["group_member"][5]["detailKeys"][]="group_id";
...
$proto0["m_strFieldList"] = "group_member_id,  	member_id AS memberID,  	member_id,  	group_id,  	user_type,  	token_group,  	identifier_group,  	token_personal,  	membership_type,  	valid";
...
$proto18["m_sql"] = "identifier_group";
...
$proto27["m_srcTableName"] = "group_member";
...
$proto26["m_table"] = $obj;
$proto26["m_sql"] = "group_member";
$proto26["m_alias"] = "";
$proto26["m_srcTableName"] = "group_member";
$proto28=array();
$proto28["m_sql"] = "";
