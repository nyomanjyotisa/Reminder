...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelspersonal_agenda["English"]["member_id"] = "Member Name";
	...
	$pageTitlespersonal_agenda["English"]["edit"] = "Edit Personal Agenda {%member_id}";
	$pageTitlespersonal_agenda["English"]["view"] = "Personal Agenda {%member_id}";
...
if( $pages[PAGE_EDIT] ) {
	...
	$tdatapersonal_agenda[".afterEditAction"] = 0;
...
$tdatapersonal_agenda[".afterAddAction"] = 4;
$tdatapersonal_agenda[".closePopupAfterAdd"] = 1;
$tdatapersonal_agenda[".afterAddActionDetTable"] = "personal_agenda_repeat_date";
}
...
$tdatapersonal_agenda[".addPageEvents"] = true;

// use timepicker for search panel
$tdatapersonal_agenda[".isUseTimeForSearch"] = true;
...
$tdatapersonal_agenda[".arrGridTabs"] = $arrGridTabs;
...
//Filters settings
	$fdata["filterTotals"] = 0;
		$fdata["filterMultiSelect"] = 0;
		$fdata["filterTotalFields"] = "member_agenda_id";
		$fdata["filterFormat"] = "Values list";
		$fdata["showCollapsed"] = false;
