...
if( $pages[PAGE_EDIT] ) {
	...
	$tdatamembership_type[".afterEditAction"] = 0;
...
$tdatamembership_type[".afterAddAction"] = 0;
...
//	your_group
		...
		$dIndex = 2;
	$detailsParam = array();
	$detailsParam["dDataSourceTable"]="your_group";
		$detailsParam["dOriginalTable"] = "group";
		...
		$detailsParam["dType"]=PAGE_LIST;
	$detailsParam["dShortTable"] = "your_group";
	$detailsParam["dCaptionTable"] = GetTableCaption("your_group");
	$detailsParam["masterKeys"] =array();
	$detailsParam["detailKeys"] =array();
...
//	new_group_request
		...
		$dIndex = 3;
	$detailsParam = array();
	$detailsParam["dDataSourceTable"]="new_group_request";
		$detailsParam["dOriginalTable"] = "group";
		...
		$detailsParam["dType"]=PAGE_LIST;
	$detailsParam["dShortTable"] = "new_group_request";
	$detailsParam["dCaptionTable"] = GetTableCaption("new_group_request");
	$detailsParam["masterKeys"] =array();
	$detailsParam["detailKeys"] =array();
