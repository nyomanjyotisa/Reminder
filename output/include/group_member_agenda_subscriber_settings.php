...
$tdatagroup_member_agenda_subscriber[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatagroup_member_agenda_subscriber[".originalPagesByType"] = $tdatagroup_member_agenda_subscriber[".pagesByType"];
$tdatagroup_member_agenda_subscriber[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatagroup_member_agenda_subscriber[".originalPages"] = $tdatagroup_member_agenda_subscriber[".pages"];
$tdatagroup_member_agenda_subscriber[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelsgroup_member_agenda_subscriber["English"]["member_id"] = "Member Name";
	...
	$fieldLabelsgroup_member_agenda_subscriber["English"]["agenda_type_id"] = "Agenda Type";
	...
	$fieldLabelsgroup_member_agenda_subscriber["English"]["group_id"] = "Group Id";
	$fieldToolTipsgroup_member_agenda_subscriber["English"]["group_id"] = "";
	$placeHoldersgroup_member_agenda_subscriber["English"]["group_id"] = "";
	$pageTitlesgroup_member_agenda_subscriber["English"]["view"] = "Group Member Agenda Subscriber {%member_id}";
...
if(mlang_getcurrentlang()=="Indonesian")
{
	...
	$fieldLabelsgroup_member_agenda_subscriber["Indonesian"]["group_member_id"] = "Id Member Group ";
	...
	$fieldLabelsgroup_member_agenda_subscriber["Indonesian"]["member_id"] = "Nama Member";
	...
	$fieldLabelsgroup_member_agenda_subscriber["Indonesian"]["agenda_type_id"] = "Tipe Agenda";
	...
	$fieldLabelsgroup_member_agenda_subscriber["Indonesian"]["group_id"] = "Group Id";
	$fieldToolTipsgroup_member_agenda_subscriber["Indonesian"]["group_id"] = "";
	$placeHoldersgroup_member_agenda_subscriber["Indonesian"]["group_id"] = "";
...
if( $pages[PAGE_EDIT] ) {
	...
	$tdatagroup_member_agenda_subscriber[".afterEditAction"] = 0;
...
$tdatagroup_member_agenda_subscriber[".afterAddAction"] = 0;
...
$tdatagroup_member_agenda_subscriber[".googleLikeFields"][] = "group_id";
...
$tdatagroup_member_agenda_subscriber[".sqlHead"] = "SELECT group_member_id,  	member_id,  	agenda_type_id,  	group_id";
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "group_member_agenda_subscriber";
	$fdata["Label"] = GetFieldLabel("group_member_agenda_subscriber","group_id");
	$fdata["FieldType"] = 20;
...
// Begin Lookup settings
	...
	$edata["DisplayField"] = "group_name";
				...
				$edata["LookupWhere"] = "group_member.valid = 1 AND group_member.member_id = ':session.member_id'";
...
//end of Filters settings
	...
	$tdatagroup_member_agenda_subscriber["group_id"] = $fdata;
		$tdatagroup_member_agenda_subscriber[".searchableFields"][] = "group_id";
...
//	group_agenda_type
	...
	$detailsTablesData["group_member_agenda_subscriber"][$dIndex] = $detailsParam;

	
		$detailsTablesData["group_member_agenda_subscriber"][$dIndex]["masterKeys"] = array();

	$detailsTablesData["group_member_agenda_subscriber"][$dIndex]["masterKeys"][]="agenda_type_id";

				$detailsTablesData["group_member_agenda_subscriber"][$dIndex]["detailKeys"] = array();

	$detailsTablesData["group_member_agenda_subscriber"][$dIndex]["detailKeys"][]="agenda_type_id";
...
$proto0["m_strFieldList"] = "group_member_id,  	member_id,  	agenda_type_id,  	group_id";
...
$proto14["m_link"] = "SQLL_MAIN";
			$proto15=array();
$proto15["m_strName"] = "group_member_agenda_subscriber";
$proto15["m_srcTableName"] = "group_member_agenda_subscriber";
$proto15["m_columns"] = array();
$proto15["m_columns"][] = "group_member_id";
$proto15["m_columns"][] = "member_id";
$proto15["m_columns"][] = "agenda_type_id";
$proto15["m_columns"][] = "group_id";
$obj = new SQLTable($proto15);

$proto14["m_table"] = $obj;
$proto14["m_sql"] = "group_member_agenda_subscriber";
$proto14["m_alias"] = "";
$proto14["m_srcTableName"] = "group_member_agenda_subscriber";
$proto16=array();
$proto16["m_sql"] = "";
