...
{
	$value = "";
				if($table=="personal_agenda" && $field=="attachment")
	{
		;
		return $value;
	}
				if($table=="group_agenda_private" && $field=="attachment")
	{
		;
		return $value;
	}
				if($table=="group_agenda" && $field=="attachment")
	{
		;
		return $value;
	}
...
function GetDefaultValue($field, $ptype, $table="")
{
				...
				if($table=="lookup_token" && $field=="id_group")
	{
		return $_SESSION["group_id"];
				...
				if($table=="group_operation_off" && $field=="group_id")
	{
		return $_SESSION["group_id"];
	}
				if($table=="group_product" && $field=="group_id")
	{
		return $_SESSION["group_id"];
				...
				if($table=="group_member_order_detail" && $field=="group_id")
	{
		return $_SESSION["group_id"];
	}
				...
				if($table=="group_member" && $field=="member_id")
	{
		return $_SESSION["member_id"];
				...
				if($table=="group_agenda" && $field=="group_id")
	{
		return $_SESSION["group_id"];
	}
				if($table=="group_agenda" && $field=="message_general")
	{
		return 1;
	}
				if($table=="group_member_checkin" && $field=="group_id")
	{
		return $_SESSION["group_id"];
				...
				if($table=="group_agenda_type" && $field=="group_id")
	{
		return $_SESSION["group_id"];
	}
				if($table=="lookup_stok" && $field=="group_id")
	{
		return $_SESSION["group_id"];
	}
				if($table=="group_product2" && $field=="group_id")
	{
		return $_SESSION["group_id"];
	}
				if($table=="group5" && $field=="valid")
	{
		return 'not valid';
	}
	return "";
