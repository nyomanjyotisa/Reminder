...
if( $pages[PAGE_EDIT] ) {
	...
	$tdatagroup_operation_off[".afterEditAction"] = 0;
...
$tdatagroup_operation_off[".afterAddAction"] = 0;
...
$masterTablesData["group_operation_off"] = array();
	...
	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["group_operation_off"][1] = $masterParams;
				$masterTablesData["group_operation_off"][1]["masterKeys"] = array();
	$masterTablesData["group_operation_off"][1]["masterKeys"][]="group_id";
				$masterTablesData["group_operation_off"][1]["detailKeys"] = array();
	$masterTablesData["group_operation_off"][1]["detailKeys"][]="group_id";
	...
	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["group_operation_off"][2] = $masterParams;
				$masterTablesData["group_operation_off"][2]["masterKeys"] = array();
	$masterTablesData["group_operation_off"][2]["masterKeys"][]="group_id";
				$masterTablesData["group_operation_off"][2]["detailKeys"] = array();
	$masterTablesData["group_operation_off"][2]["detailKeys"][]="group_id";
...
$tdatagroup_operation_off[".hasEvents"] = true;
