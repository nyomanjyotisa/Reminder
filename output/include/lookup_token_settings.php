...
if( $pages[PAGE_EDIT] ) {
	...
	$tdatalookup_token[".afterEditAction"] = 0;
...
$tdatalookup_token[".afterAddAction"] = 0;
...
$masterTablesData["lookup_token"] = array();
	...
	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["lookup_token"][1] = $masterParams;
				$masterTablesData["lookup_token"][1]["masterKeys"] = array();
	$masterTablesData["lookup_token"][1]["masterKeys"][]="group_id";
				$masterTablesData["lookup_token"][1]["detailKeys"] = array();
	$masterTablesData["lookup_token"][1]["detailKeys"][]="id_group";
	...
	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["lookup_token"][2] = $masterParams;
				$masterTablesData["lookup_token"][2]["masterKeys"] = array();
	$masterTablesData["lookup_token"][2]["masterKeys"][]="group_id";
				$masterTablesData["lookup_token"][2]["detailKeys"] = array();
	$masterTablesData["lookup_token"][2]["detailKeys"][]="id_group";
