...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelspersonal_agenda_repeat_date["English"]["member_agenda_id"] = "Member Agenda";
...
if(mlang_getcurrentlang()=="Indonesian")
{
	...
	$fieldLabelspersonal_agenda_repeat_date["Indonesian"]["member_agenda_id"] = "Agenda Member";
	...
	$fieldLabelspersonal_agenda_repeat_date["Indonesian"]["dodate"] = "Tanggal";
...
if( $pages[PAGE_EDIT] ) {
	...
	$tdatapersonal_agenda_repeat_date[".afterEditAction"] = 0;
...
$tdatapersonal_agenda_repeat_date[".afterAddAction"] = 0;
...
$tdatapersonal_agenda_repeat_date[".hasEvents"] = true;
