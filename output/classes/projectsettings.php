...
function fillProjectEntites()
{
	...
	$projectEntities[ "group111" ] = array( "url" => "group111", "type" => 1 );
	$projectEntitiesReverse[ "group111" ] = "group111";
	$projectEntities[ "group_product11" ] = array( "url" => "group_product11", "type" => 1 );
	$projectEntitiesReverse[ "group_product11" ] = "group_product11";
	$projectEntities[ "lookup_stok" ] = array( "url" => "lookup_stok", "type" => 0 );
	$projectEntitiesReverse[ "lookup_stok" ] = "lookup_stok";
	$projectEntities[ "outbox_line" ] = array( "url" => "outbox_line", "type" => 0 );
	$projectEntitiesReverse[ "outbox_line" ] = "outbox_line";
	$projectEntities[ "outbox_whatsapp" ] = array( "url" => "outbox_whatsapp", "type" => 0 );
	$projectEntitiesReverse[ "outbox_whatsapp" ] = "outbox_whatsapp";
	$projectEntities[ "product_for_order" ] = array( "url" => "product_for_order", "type" => 6 );
	$projectEntitiesReverse[ "product_for_order" ] = "product_for_order";
	$projectEntities[ "your_group" ] = array( "url" => "your_group", "type" => 1 );
	$projectEntitiesReverse[ "your_group" ] = "your_group";
	$projectEntities[ "new_group_request" ] = array( "url" => "new_group_request", "type" => 1 );
	$projectEntitiesReverse[ "new_group_request" ] = "new_group_request";
	$projectEntities[ "group_product2" ] = array( "url" => "group_product2", "type" => 1 );
	$projectEntitiesReverse[ "group_product2" ] = "group_product2";
	$projectEntities[ "group5" ] = array( "url" => "group5", "type" => 1 );
	$projectEntitiesReverse[ "group5" ] = "group5";
}
