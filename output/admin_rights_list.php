...
$pageMask[$table] = $mask;
$tables[$table] = array("group111", " " . GetTableCaption("group111"));
$table = "group_product11";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
if( pageEnabled($table, 'edit') || pageEnabled($table, 'inline_edit') )
...
$pageMask[$table] = $mask;
$tables[$table] = array("group_product11", " " . GetTableCaption("group_product11"));
$table = "lookup_stok";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("lookup_stok", " " . GetTableCaption("lookup_stok"));
$table = "outbox_line";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("outbox_line", " " . GetTableCaption("outbox_line"));
...
$pageMask[$table] = $mask;
$tables[$table] = array("outbox_whatsapp", " " . GetTableCaption("outbox_whatsapp"));
$table = "product_for_order";
$mask="";
if( pageEnabled($table, 'view') || pageEnabled($table, 'list') || pageEnabled($table, 'chart') || pageEnabled($table, 'report') || pageEnabled($table, 'dashboard') )
	$mask .= "S";
if( pageEnabled($table, 'print') || pageEnabled($table, 'rprint') || pageEnabled($table, 'export')  )
...
$pageMask[$table] = $mask;
$tables[$table] = array("product_for_order", " " . GetTableCaption("product_for_order"));
$table = "your_group";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("your_group", " " . GetTableCaption("your_group"));
$table = "new_group_request";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
if( pageEnabled($table, 'edit') || pageEnabled($table, 'inline_edit') )
...
$pageMask[$table] = $mask;
$tables[$table] = array("new_group_request", " " . GetTableCaption("new_group_request"));
$table = "group_product2";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
if( pageEnabled($table, 'edit') || pageEnabled($table, 'inline_edit') )
...
$pageMask[$table] = $mask;
$tables[$table] = array("group_product2", " " . GetTableCaption("group_product2"));
$table = "group5";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("group5", " " . GetTableCaption("group5"));
